...
class TodayDayOrderState extends State<TodayDayOrder> {
  ...
  void _getLocation() async {
    ...
    if (permission == LocationPermission.whileInUse ||
      ...
      bool isLocationServiceEnableds = await isLocationServiceEnabled();
      if (isLocationServiceEnableds) {
        ...
        await openLocationSettings().then((value) {
          if (value) {
            _getLocation();
          } else {
      ...
      LocationPermission permissiond = await requestPermission();
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  RaisedButton(
                                                    ...
                                                    onPressed: () {
                                                      _getDirection(
                                                          'https://www.google.com/maps/search/?api=1&query=${pharmaOrder[index].user_lat},${pharmaOrder[index].user_lng}');
                                                    },
                                                    child: Text(
                                                      'Get Direction',
                                                      textAlign:
